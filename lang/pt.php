<?php
 return  [
  'header'=>[
    'page-title'=>'BOMB PIX - Detone. enriqueça. domine.',
    'item1'=>'Início',
    'item2'=>'Roadmap',
    'item3'=>'Whitepaper',
    'item4'=>'Bombers',
  ...
  'hero'=>[
    'title'=>'DETONE. ENRIQUEÇA. DOMINE. BOMB PIX:',
    'subtitle'=>'O jogo explosivo que transforma suas vitórias em riquezas reais!'
  ],
  'where'=>[
    'over_title'=>'de onde vem as',
    'title'=>'bombcoins',
    'button'=>'ver todos',
    'popup_title'=>'de onde vem as bombcoins?',
    'popup_text'=>'Bombcoins, a moeda explosiva, tem sua origem envolta em mistério.
  ...
  'marketplace' => [
    ...
    'menu_item1'=>'Loja',
    'menu_item1_subitem1'=>'Farm',
    'menu_item1_subitem2'=>'PvP',
    'menu_item1_subitem3'=>'Aventura',
    'menu_item2'=>'Jogar agora',
    'menu_item2_subitem1'=>'Farm',
    'menu_item2_subitem2'=>'PvP',
    'menu_item2_subitem3'=>'Aventura',
    'menu_item3'=>'Minha conta',
    'menu_item4'=>'Whitepaper',
    'menu_item4_subitem1'=>'Pt',
    'menu_item4_subitem2'=>'En',
    'menu_item4_subitem3'=>'Es',
    'menu_item4_subitem4'=>'Ch',
    'menu_item5'=>'Lands',
    'data_item1'=>'Amigos:',
    'data_item2'=>'Saldo:',
    ...
    'products'=>[
      'type1'=>[
        ...
        'description'=>'Rendimento até 30%',
        'image'=>'bau-verde-claro',
        'value'=>'10'
      ],
      'type2'=>[
        'name'=>'BAÚ COMUM',
        'description'=>'Rendimento até 35%',
        'image'=>'bau-vermelho',
        'value'=>'40'       
      ],
      'type3'=>[
        'name'=>'BAÚ RARO',
        'description'=>'Rendimento até 40%',
        'image'=>'bau-azul',
        'value'=>'100'       
      ],
      'type4'=>[
        'name'=>'BAÚ ÉPICO',
        'description'=>'Rendimento até 50%',
        'image'=>'bau-verde-escuro',
        'value'=>'200'    
      ],
      'type5'=>[
        'name'=>'BAÚ LENDÁRIO',
      ...
      'type6'=>[
        'name'=>'BAÚ MÍTICO',
        'description'=>'Rendimento até 55%',
        'image'=>'bau-roxo',
        'value'=>'1000'   
      ],
      'type7'=>[
        'name'=>'BAÚ ULTRA MÍTICO',
        'description'=>'Rendimento até 60%',
        'image'=>'bau-rosa',
        'value'=>'2000'       
      ],
      'type8'=>[
        'name'=>'BAÚ DIAMANTE',
        'description'=>'Rendimento até 65%',
        'image'=>'bau-amarelo',
        'value'=>'3000'        
      ],
    ],
